...
|---|---:|---:|---:|
| Dijkstra (array) | 16.90 | 28 | 19 |
| Dijkstra (binary heap) | 6.90 | 28 | 19 |
| Dijkstra (transport) | 9.20 | 28 | 19 |
| Bellman-Ford | 12.30 | 224 | n/a |

## 2) Point-to-Point: source = 13 (New Admin. Capital), target = 7 (6th October)

| Algorithm | Median time (μs) | Edge relaxations | PQ extractions |
|---|---:|---:|---:|
| Dijkstra (binary heap, full SSSP) | 11.00 | 28 | 19 |
| Dijkstra (transport, early exit) | 9.50 | 25 | 17 |
| A* (haversine heuristic) | 7.60 | 33 | 11 |

## 3) All-Pairs Shortest Paths

| Algorithm | Median time (μs) | Operations |
|---|---:|---:|
| Dijkstra-heap × V | 122.40 | 532 relax, 367 pops |
| Floyd-Warshall | 30.80 | 7450 updates |
